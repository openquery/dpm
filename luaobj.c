...
#define DPM_D(x) \
    ...
    DPM_D(SERVER_STATUS_IN_TRANS);
    DPM_D(SERVER_STATUS_AUTOCOMMIT);
    DPM_D(SERVER_MORE_RESULTS_EXISTS);
    DPM_D(SERVER_QUERY_NO_GOOD_INDEX_USED);
    DPM_D(SERVER_QUERY_NO_INDEX_USED);
